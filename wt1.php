...
<div class="offcanvas offcanvas-start text" data-bs-scroll="true"  id="offcanvas" style="background-image:url('pink.jpeg');">
  <div class="offcanvas-header">
    <h5 class="offcanvas-title" id="offcanvasWithBothOptionsLabel">BEAUTY PARLOUR Website</h5>
    <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
  </div>
  <div class="offcanvas-body">
    Hello  everyone , i am aPavithra  .I want to explain a  information about this website.It is small website and it is very useful to us.We are selling beauty product that are very natural,organic and ecofriendly products. 
